...
![logo](sportsee-front/src/assets/logo.svg)
...
- [REACT (**version 18.2**)](https://en.reactjs.org/)
...
- Backend :
  open a new terminal and run `cd sportsee-back` command,
  then run `yarn start`command
  the backend will open http://localhost:4000
